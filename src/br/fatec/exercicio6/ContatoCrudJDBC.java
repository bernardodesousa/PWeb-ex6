...
public class ContatoCrudJDBC {
	...
	public void salvar(Contato contato) {
		...
		try {
			...
			System.out.println("Erro ao incluir contato\n" + e.getMessage());
		}
	}
	...
	public List<Contato> listar() {
		...
		try {
			...
			System.out.println("Erro ao listar contato\n" + e.getMessage());
			...
			try {
				...
				System.out.println("Erro ao fechar operação consulta\n" + e.getMessage());
	...
	public Connection geraConexao() {
		...
		try {
			...
			String url = "jdbc:derby://localhost:1527/ex6;create=true;update=true';";
